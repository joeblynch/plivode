/* Copyright (c) 2012-2014 Joe Lynch <yhf@ncsc.io>, http://plivode.ncsc.io/
...
var ApiClient = module.exports = Compose(function(auth) {
    ...
    _request: function(method, resources, params, expectStatus, cb) {
        ...
        var postData = method === 'POST' && JSON.stringify(params);
        ...
        var req = https.request({
            ...
            headers: method === 'POST' ? { 'Content-Type': 'application/json', 'Content-Length': postData.length } : null
        }, function(res) {
            var buf = [];
