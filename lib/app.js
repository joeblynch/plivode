...
var App = module.exports = Compose(EventEmitter, ApiClient, function(opts) {
    ...
    this.Application = Compose.create(this.Application, {
        _super: this.Application,

        update: function(urls, cb) {
            this._super.update.call(self, self.appID, urls, cb);
            return this;
        }
    });

    this.Call = Compose.create(this.Call, {
        _super: this.Call,

        outbound: function(from, to, cb) {
            this._super.outbound.call(self, from, to, self._getCallbackUrl(cb));
        }
    })
}, {
